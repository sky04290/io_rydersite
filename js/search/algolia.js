window.addEventListener('load', () => {
  ...
  search.addWidget(
    instantsearch.widgets.hits({
      ...
      templates: {
        item: function (data) {
          let link = data.permalink ? data.permalink : (GLOBAL_CONFIG.root + data.path)
          var regex = /fuguiliu.github.io/;
          // 看是否包含 github.fuguiliu.io
          if (regex.test(link)) {
            link = link.replace(/fuguiliu.github.io/, "ryder.pw");
          }
